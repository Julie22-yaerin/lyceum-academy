  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col gap-8 py-8">
      <div className="text-center">
        <span className="font-sans text-[10px] font-semibold text-on-surface opacity-50 tracking-[2px] uppercase block mb-2">Playground</span>
        <h2 className="font-serif text-2xl text-on-surface">2D Game Builder</h2>
        <p className="font-sans text-xs opacity-50 mt-2">Generate sprites locally (CPU — can take up to ~2 minutes), drag them onto the stage, and give them behavior.</p>
      </div>
